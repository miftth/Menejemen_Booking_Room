...
<head>
    ...
    <style>
        :root{ --bg-900: #05060b; --bg-800: #0b1120; --glass: rgba(255,255,255,0.03); --glass-2: rgba(255,255,255,0.025); --glass-border: rgba(255,255,255,0.06); --muted: #9aa4b2; --accent-cyan: #5ee8ff; --accent-purple: #a78bfa; --accent-green: #3ee89a; --card-shadow: 0 12px 40px rgba(2,6,23,0.6); font-family: Inter, ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial;}
        html,body { height:100%; color: #e6eef8; margin:0; padding:0; }
        .wrap { max-width:1200px; margin:28px auto; padding:22px; border-radius:16px; border:1px solid var(--glass-border); background: linear-gradient(180deg, rgba(255,255,255,0.015), rgba(255,255,255,0.01)); box-shadow: var(--card-shadow); backdrop-filter: blur(8px) saturate(120%); }
