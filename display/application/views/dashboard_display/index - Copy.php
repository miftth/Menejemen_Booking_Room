...
<head>
    ...
    <style>
        ...
        .time .clock { font-size: 64px; font-weight: 700; }
        .time .date { font-size: 16px; color: #ccc; margin-top: 5px; }

        .content { flex: 1; display: flex; margin-top: 25px; gap: 30px; height: 500px;}
        ...
        .meeting time { display: block; font-size: 14px; color: #aaa; }
        .meeting .title { font-size: 17px; font-weight: 500; margin-top: 4px; }
    </style>
</head>
<body>
    <div class="header">
        <h1><?php foreach($data_ruangan as $room){ ?><?= htmlspecialchars($room['nama_ruangan']); ?><?php } ?> 🌍<br>
            <small style="font-size:16px;font-weight:300;">IP Room : <?php if($_SERVER['REMOTE_ADDR'] == '::1'){ ?> 127.0.0.1 </small><?php }else{ ?> <?=$_SERVER['REMOTE_ADDR']?><?php } ?>
        </h1>
        <div class="time">
    ...
    <div class="content"> 
        <div class="left">
            <strong style="font-size:20px; display:block;">Today's Meetings</strong>
            <div class="meetings">
        ...
        <div class="right">
            <strong style="font-size:20px; display:block; margin-bottom: 15px;">Next Day Meeting</strong>
            <div class="meetings">
